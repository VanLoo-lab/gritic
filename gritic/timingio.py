...
# Version 4 makes gained-route particle entries self-describing.  Keep these
# field and encoding constants in this dependency-light module so downstream
# consumers do not need to import GRITIC's inference or route-tree machinery.
TIMING_ARCHIVE_VERSION = 4
...
ROUTE_PARTICLE_TIMING_NODE_ID_KEY = 'Timing_Node_ID'
ROUTE_PARTICLE_WGD_TIMING_KEY = 'WGD_Timing'
ROUTE_PARTICLE_MULT_KEY = 'Mult'
ROUTE_PARTICLE_INTERVAL_START_SOURCE_KEY = 'Interval_Start_Source'
ROUTE_PARTICLE_INTERVAL_END_SOURCE_KEY = 'Interval_End_Source'
ROUTE_PARTICLE_INTERVAL_MULTIPLICITY_KEY = 'Interval_Multiplicity'
ROUTE_PARTICLE_INTERVAL_PHASING_KEY = 'Interval_Phasing'
ROUTE_PARTICLE_STATE_COLUMN_OFFSETS_KEY = 'State_Column_Offsets'
ROUTE_PARTICLE_STATE_COLUMNS_KEY = 'State_Columns'
ROUTE_PARTICLE_TARGET_MAJOR_CN_KEY = 'Target_Major_CN'
ROUTE_PARTICLE_TARGET_MINOR_CN_KEY = 'Target_Minor_CN'
ROUTE_PARTICLE_N_SUBCLONES_KEY = 'N_Subclones'
ROUTE_PARTICLE_TARGET_WGD_STATUS_KEY = 'Target_WGD_Status'
ROUTE_PARTICLE_MODEL_MAJOR_CN_KEY = 'Model_Major_CN'
ROUTE_PARTICLE_MODEL_MINOR_CN_KEY = 'Model_Minor_CN'
ROUTE_PARTICLE_MODEL_WGD_STATUS_KEY = 'Model_WGD_Status'
ROUTE_PARTICLE_ARCHIVE_KIND_KEY = 'Archive_Kind'

ROUTE_PARTICLE_ARCHIVE_FIELDS = frozenset({
    ROUTE_PARTICLE_PROBABILITY_KEY,
    ROUTE_PARTICLE_PENALIZED_PROBABILITY_KEY,
    ROUTE_PARTICLE_TIMING_KEY,
    ROUTE_PARTICLE_TIMING_NODE_ID_KEY,
    ROUTE_PARTICLE_WGD_TIMING_KEY,
    ROUTE_PARTICLE_MULT_KEY,
    ROUTE_PARTICLE_INTERVAL_START_SOURCE_KEY,
    ROUTE_PARTICLE_INTERVAL_END_SOURCE_KEY,
    ROUTE_PARTICLE_INTERVAL_MULTIPLICITY_KEY,
    ROUTE_PARTICLE_INTERVAL_PHASING_KEY,
    ROUTE_PARTICLE_STATE_COLUMN_OFFSETS_KEY,
    ROUTE_PARTICLE_STATE_COLUMNS_KEY,
    ROUTE_PARTICLE_TARGET_MAJOR_CN_KEY,
    ROUTE_PARTICLE_TARGET_MINOR_CN_KEY,
    ROUTE_PARTICLE_N_SUBCLONES_KEY,
    ROUTE_PARTICLE_TARGET_WGD_STATUS_KEY,
    ROUTE_PARTICLE_MODEL_MAJOR_CN_KEY,
    ROUTE_PARTICLE_MODEL_MINOR_CN_KEY,
    ROUTE_PARTICLE_MODEL_WGD_STATUS_KEY,
    ROUTE_PARTICLE_ARCHIVE_KIND_KEY,
})

ROUTE_PARTICLE_ARCHIVE_KIND_SEGMENT = np.uint8(0)
ROUTE_PARTICLE_ARCHIVE_KIND_POOLED_WGD = np.uint8(1)

# Interval endpoint sources.  Values from TIMING_SOURCE_COLUMN_OFFSET onward
# select a column from the route's two-dimensional Timing array.
TIMING_SOURCE_ZERO = 0
TIMING_SOURCE_ONE = 1
TIMING_SOURCE_WGD = 2
TIMING_SOURCE_COLUMN_OFFSET = 3

# Interval_Phasing bit assignments and State_Column_Offsets ordering.
ROUTE_PARTICLE_PHASING_ORDER = ('non_phased', 'major', 'minor')
PHASING_BIT_NON_PHASED = np.uint8(1)
PHASING_BIT_MAJOR = np.uint8(2)
PHASING_BIT_MINOR = np.uint8(4)
ROUTE_PARTICLE_PHASING_BITS = {
    'non_phased': PHASING_BIT_NON_PHASED,
    'major': PHASING_BIT_MAJOR,
    'minor': PHASING_BIT_MINOR,
}
